...
const ForwardedPressableOpacity = forwardRef<View, PressableOpacityProps>((props, ref) => (
  <PressableOpacity {...props} ref={ref} />
));
ForwardedPressableOpacity.displayName = "PressableOpacity";

export default ForwardedPressableOpacity;